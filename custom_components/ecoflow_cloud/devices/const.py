...
SOLAR_IN_POWER = "Solar (1) (LV) In Power"
SOLAR_1_IN_POWER = "Solar (1) In Power"
SOLAR_2_IN_POWER = "Solar (2) (HV) In Power"
SOLAR_1_IN_VOLTS = "Solar (1) In Volts"
SOLAR_2_IN_VOLTS = "Solar (2) (HV) In Volts"
SOLAR_1_IN_AMPS = "Solar (1) In Amps"
SOLAR_2_IN_AMPS = "Solar (2) (HV) In Amps"
AC_IN_POWER = "AC In Power"
AC_IN_VOLT = "AC In Volts"
AC_OUT_VOLT = "AC Out Volts"

TYPE_C_IN_POWER = "Type-C In Power"
SOLAR_IN_CURRENT = "Solar (1) (LV) In Current"
SOLAR_IN_VOLTAGE = "Solar (1) (LV) In Voltage"
